...
class EventTesterPackage extends Package {
	...
	public function on_start() {
		...
		$events = array('on_group_delete', 'on_page_update', 'on_page_move', 'on_page_duplicate', 'on_page_delete', 'on_page_add', 'on_page_version_approve', 'on_page_version_add', 'on_user_add', 'on_user_delete', 'on_user_update', 'on_user_login', 'on_user_change_password', 'on_page_get_icon');
